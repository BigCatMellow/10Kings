# Naming History Vertical Slices

## Status

**Reference / design tests — not canon.**

These are the first concrete tests of the historical naming model in [Language History and Naming Audit](Language-History-and-Naming-Audit.md).

They deliberately use **existing legacy names** instead of generating a new conlang.

The goal is to see whether a name can accumulate believable layers from history, trade, administration and local use.
...
# Implications for existing names
...
# Personal-name test deferred

The next naming test should be personal rather than geographic.

[Wurdren](../Story/Wurdren.md) is the best candidate because the name is protected by story importance.

The test should determine:

- whether it sounds old-fashioned;
- what community / language produced it;
- whether its current spelling is Port / Highridge transliteration;
- whether it has a shorter familiar form;
- what people infer from hearing it.

Do **not** answer these by inventing a fantasy etymology first.

First establish one or two personal naming systems and see where Wurdren naturally fits.

---

# Promotion result

These tests support the following design rules:

1. one place can have simultaneous local, legal and commercial names;
2. descriptive English compounds work best as translations, exonyms, nicknames or later names unless history supports them;
3. commercial / guild identities can become political place names;
4. old opaque names can remain semantically unresolved;
5. speaker choice among names can reveal class, profession, generation and politics;
6. exact invented-language forms should wait until the world needs them.

These rules can be used immediately without building full conlangs.

...
**Working canon at the topology level.**

The broad physical arrangement and the major circulation pressures are now established well enough to guide later work. Exact coastlines, river courses, distances, borders, pass placement, and the final site of Port are still open.
...
A pass, river, strait, tunnel, ferry, seasonal road, or reliable harbor can make distant places functionally close. A ridge, storm belt, collapsed road, bad anchorage, or closed tunnel can make neighbors functionally distant.

## Rough topology

This is a topology diagram, not a scale map and not a statement of exact borders.

```text
                         NORTHWIND
                   Northern Continent
                 cold seas / islands / bays
                            |
                 constrained southern access
                            |
            ------------------------------------
            |                                  |
       THE SPINE /                         EASTERN
...
The diagram is intentionally conservative. It records the network relationships that survive reconciliation without pretending that unresolved geometry is already known.

## Continental structure

### Western Continent

The Western Continent is the smaller rounded western landmass in the older source model.
...
- irregular, highly indented coasts;
- fjords, islands, protected bays, and natural harbors;
...
The Eastern Continent is the largest and most internally varied landmass.
...
- high ridges that are genuinely expensive to cross;
- inhabited valleys;
- plateaus and shoulders;
- a small number of major passes;
...
The exact rivers are not yet named or drawn, but the world already requires several hydrological systems.
...
- broad agricultural floodplains;
- mill towns;
- river quays;
...
- irrigation;
- orchard and city-state agriculture;
- canal and diversion politics;
...
- road placement;
- forest-border agriculture;
- which parts of the forest are easy or hard for outsiders to penetrate.

The final map should make some water systems cross political boundaries. Water politics become less interesting if every watershed conveniently belongs to one state.
...
2. access to the main north ↔ south maritime circulation;
3. usable inland connection by river, road, or both;
4. enough fresh water and nearby food supply to support a large city;
5. defensibility without allowing one neighboring kingdom to dominate it cheaply;
6. a historical reason neutral status was preferable to conquest;
7. enough route convergence that merchants keep using it even when they dislike its fees or politics.
...
A major west/east economic relationship through foothills, passes, roads, and possibly river valleys.

Typical movement:

- metal, tools, craft goods → east;
- food, animals, agricultural goods → west;
- labor, fuel, investment, debt, and families → both directions.
...
The transition should follow warmer lowlands, river systems, and agricultural corridors rather than an arbitrary straight border.
...
Forest uplands meet exposed plateau routes.

This should create:

- forest-product movement into caravan networks;
- water and road disputes;
- mixed settlements;
...
Logging, charcoal, ore, tools, and forest-edge conflict require a plausible connection around the central uplands.
...
Field-to-forest transition, historical encroachment, rivers, and forest-edge markets make a direct boundary highly likely.
...
- secondary harbors;
- Port;
- fisheries and preserved-goods markets;
- convoy and piracy zones.
...
- Port;
- regional craft and luxury markets.

### Port as transfer point

Port's importance increases if northern and southern systems can exchange there without every ship sailing every route.
...
- mixed crews and merchant communities.
...
- **crossing route** — bypasses difficult surface passes;
- **local network** — connects mountain and underground communities;
- **contingency network** — becomes more valuable when official surface routes fail.
...
A future map should be rejected if it makes any of these true:
...
This reconstruction reconciles the current owner pages with preserved legacy material, especially:

- [Two Sons — Complete Reference](../legacy-notes/2026-09-22/direct-uploads/Two_Sons_-_Complete_Reference.md);
- [Foundations — World, Myth & History](../legacy-notes/2026-09-22/consolidated-package/01_Foundations_World_Myth_History.md);
- the archived [continent map](../legacy-notes/2026-09-22/consolidated-package/Map_-_The_Continent.png).

The older notes are evidence of prior intent, not automatic canon. Where they conflict with later owner pages, the conflict remains explicit rather than silently choosing the older version.

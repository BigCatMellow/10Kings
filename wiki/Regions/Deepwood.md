...
Outsiders repeatedly pushed into forest margins for:
- farmland;
- fuel;
- timber;
- hunting;
...
- Amazonian forest societies;
- Dayak/Bornean longhouse communities;
- Japanese managed woodland traditions;
- Indigenous North American forest societies;
- Baltic, Slavic, Finnic, and Celtic woodland cultures;
- historical forest economies worldwide.
...
- cutting rights;
- regrowth;
- inherited versus directly observed knowledge.

This encourages environmental attention without implying supernatural wisdom.
...
It may grow around existing tree stands or waterways rather than imposing a geometric plan.

### Towns

Many towns are specialized:
- river trade;
- forest products;
- hunting;
- timber;
...
Longhouse forms, raised floors, covered walkways, courtyards, and detached work shelters may appear depending on climate.

### Rural homes

Remote households use local timber, bark, woven materials, clay, stone, and thatch.
...
Possible staples:
- forest tubers;
- grains from clearings or trade;
- nuts;
- fungi;
- fish;
- game;
- domestic animals in settled areas;
- greens;
- berries;
- honey;
- fermented foods.

Foraging supplements agriculture rather than replacing it everywhere.
...
- fungal disease affecting food or trade species;
- conflict between isolationists and outward-looking reformers;
- criminal exploitation of hidden routes;
- Council infrastructure/resource interests;
- Villain attempts to turn legitimate conservation disputes into regional crisis.

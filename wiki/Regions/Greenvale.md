...
- Andean cooperative agriculture;
- South and Southeast Asian irrigation communities;
- Irish rural social traditions;
- Indigenous seed stewardship in the Americas;
- Eastern European mixed farming;
- diverse village-compound and commons systems worldwide.
...
Possession may also distinguish purely personal property from land or resources held in stewardship for family/community.

This can reinforce attention to process, inheritance, and long-term obligation.

## Settlement and architecture

### Cities

Agricultural cities are not giant villages. They are:
- market centers;
- milling centers;
- administrative hubs;
- storage and redistribution points;
- craft centers;
- religious and legal seats.

Expect:
- large granaries;
- mills;
- river quays where possible;
- dense working-class districts;
- wealthy landowning quarters;
- market courts;
- caravan yards.

### Towns

Towns vary with local ecology:
- floodplain settlements may use raised floors;
- drier towns use earthen or timber compounds;
- estate towns may center on a manor or market hall;
- cooperative villages may cluster around common storage, wells, and work yards.

### Rural homes

Farmsteads are mixed-purpose complexes:
- sleeping/cooking space;
- animal shelter;
- grain storage;
- tools;
- kitchen gardens;
...
- eggs;
- poultry;
- pork/goat/lamb depending on district;
- vegetables;
- fruit;
- preserves;
- soups and stews;
- pies, dumplings, flatbreads, and filled breads.

Class and season matter greatly.

Celebrations center on abundance, storage, first harvests, seed exchange, and survival after bad years.

Ciders, ales, fruit wines, and grain spirits are plausible.

## Politics

Political conflict centers on:
- land tenure;
- water rights;
- tenant obligations;
- storage;
...
- suspicion about where innovations came from;
- collapsing farm prices despite high output;
- land consolidation;
- sabotage of irrigation or crops;
- conflict between co-ops and large estates;
- Villain attempts to turn abundance into distrust and scarcity elsewhere.

...
**Working canon at the pattern level.** The existence of strong interregional dependencies is established by the setting's core design. Exact quantities, market shares, route monopolies, prices, and treaty terms remain provisional unless fixed elsewhere.

Canonical neighbors:

- [Geography and Connections](../Geography-and-Connections.md) owns physical adjacency and route logic.
...
- [Money, Credit, Exchange, and Measures](../Money-Credit-and-Measures.md) owns the settlement layer: coin, credit, account obligations, currency conversion, weights, measures, and financial interoperability.
...
Trade also does not require one universal coin. Long-distance exchange can combine physical money, credit, account settlement, guarantees, and converted local measures.
...
- **Spring:** roads and passes reopen unevenly; planting competes with migrant labor; fleets relaunch.
- **Summer:** shipping and production can peak, while heat and water pressure rise in warmer regions.
- **Autumn:** harvest, storage, bulk trade and storm risk collide.
- **Winter:** northern routes become unreliable, Port traffic can thin, stored food matters more and maintenance replaces some production.

Use these as pressures, not a universal calendar. Local altitude, latitude, weather and politics can override the pattern.

## Story use

A useful dependency event should have second- and third-order effects.

Example:

1. piracy or storms increase shipping risk;
2. Port credit and insurance-like contracts tighten;
3. distant merchants cancel or delay purchases;
4. a producing region faces local oversupply;
5. debtors fail;
6. opportunistic buyers acquire distressed assets;
7. guilds, faiths and political factions interpret the crisis differently;
8. the Council tries to stabilize a bottleneck;
9. the Villain exploits the visible consequences;
10. Wurdren encounters the human cost.

The causal chain matters more than assigning one region a fixed role.

## Source

Reconciled from the 2026-09-22 import documented in [Source Register](../Reference/Source-Register.md), especially the world-dynamics notes. Absolute claims in that source were deliberately softened where they conflicted with current world rules.
